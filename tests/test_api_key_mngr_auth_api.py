...
def main():
    ...
    try:
        ...
        print(f"로그인 페이지 상태 코드: {login_page_response.status_code}")
        
        # 로그인 폼 데이터 추출 (CSRF 토큰 등)
        ...
        print(f"로그인 요청 상태 코드: {login_response.status_code}")
        ...
        print("\n" + "=" * 50)
        print("인증된 상태의 API 테스트가 완료되었습니다!")
